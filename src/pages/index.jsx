...
const features = [
  {
    ...
    description: 'Operating System is a system software that acts as an interface between the user and the computer hardware.',
    link: '/Os',
    icon: '/img/OperatingSystem.svg',
    tags: [
      { name: 'Operating System', color: 'blue' },
