...
const config = {
  title: 'Harshwardhan ',
  tagline: 'Notes From Harshwardhan ',
  favicon: 'img/hw.svg',
  ...
  url: 'https://notes.harshwardhansingh.com',
  ...
  organizationName: 'harshwardhansingh', // Usually your GitHub org/user name.
